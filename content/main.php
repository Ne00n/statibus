      ...
      <div class="services">
          ...
          if (isset($services['values'])) {
            foreach ($services['values'] as $service) {
              ...
              echo '<div class="service"><a href="index.php?service='.tools::escape($service[0]).'"><p class="inline">'.$service[1].'</p></a><span class="green inline pull-right mt-1 mr-1">'.($data ? round(tools::escape($data[5]),2)."%" : 'n/a').'</span></div>';
